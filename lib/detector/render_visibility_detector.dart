...
mixin RenderVisibilityDetectorBase on RenderObject {
  ...
  static List<int> _shownKeys = <int>[];
  ...
  void _fireCallback(ContainerLayer? layer, Rect bounds) {
    ...
    // If the visible fraction is the same as the last time, don't fire
    ...
    if (_shownKeys.length > 200) _shownKeys.removeRange(0, 150);
