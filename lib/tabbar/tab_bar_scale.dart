...
class WrapperTabBar extends TabBar {
  ...
  @override
  State<TabBar> createState() => _WrapperTabBarState();
}
...
class _WrapperTabBarState extends State<WrapperTabBar> {
  ...
  @override
  void didUpdateWidget(WrapperTabBar oldWidget) {
  ...
  Widget _buildStyledTab(Widget child, bool isSelected,
    ...
    return _TabStyle(
      ...
      needTextScale: widget.needTextScale,
